...
import { Button, Flex, Heading, Separator, Strong, TextField, Text } from '@radix-ui/themes';
  ...
  return (
    <>
      <Flex direction="column" align="center" gap="5">
        ...
        <Flex direction="column" align="center" gap="3" style={{ maxWidth: '200px' }}>
          ...
          <Flex gap="2" align="center" style={{ maxWidth: '200px' }}>
            <Separator size="2" />
            <Strong>Vs</Strong>
            <Separator size="2" />
          </Flex>
        ...
        <Flex direction="column" align="center" gap="2" width="100%">
          ...
          <Text color="red" size="1" align="center" style={{ maxWidth: '75%' }}>
            {errorMessage}
          </Text>
        </Flex>
      </Flex>
